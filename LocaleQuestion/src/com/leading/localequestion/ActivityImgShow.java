...
public class ActivityImgShow extends ActivityCommon{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView) findViewById(R.id.photo_img_show);
        textView=(TextView)findViewById(R.id.photo_show_txt);
       
		TitleBarLayout titleBar=(TitleBarLayout)this.findViewById(R.id.photo_show_tbl);
		titleBar.getLeftBtn().setVisibility(View.VISIBLE);
		titleBar.getLeftBtn().setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View arg0) {
				ActivityImgShow.this.finish();
			}
    ...
    protected void initPage(){
         ...
         Drawable drawable = Drawable.createFromPath(intent.getStringExtra("affixPath"));
 		String content=intent.getStringExtra("affixName");
