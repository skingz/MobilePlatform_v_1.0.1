...
public class NotificationIQ extends IQ {
    ...
    public String getViewApp(){return viewApp;}
    public void setViewApp(String app){this.viewApp=app;}
    
    public String getFSIID(){return fsiid;}
    public void setFSIID(String fsiid){this.fsiid=fsiid;}
